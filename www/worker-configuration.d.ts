/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.jsonc -c ../users/wrangler.jsonc -c ../sessions/wrangler.jsonc` (hash: 490b0a80308511c1d0823cd4cb362e9d)
// Runtime types generated with workerd@1.20251105.0 2025-11-09 nodejs_als
declare namespace Cloudflare {
	...
	interface Env {
		...
		SCHEME: string;
		PORT: string;
		USER: DurableObjectNamespace<import("../users/src/index").UserDataPlane>;
		SESSION: DurableObjectNamespace<import("../sessions/src/index").SessionDataPlane>;
		USERS: Service<typeof import("../users/src/index").default>;
		SESSIONS: Service<typeof import("../sessions/src/index").default>;
		ASSETS: Fetcher;
	}
}
