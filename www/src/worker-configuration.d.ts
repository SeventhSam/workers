/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 46cf2213ab0245e8ff17c544fc29d0aa)
...
declare namespace Cloudflare {
	...
	interface Env {
		USER_CONTROL_PLANE: DurableObjectNamespace /* UserControlPlane from user */;
		USER_DATA_PLANE: DurableObjectNamespace /* UserDataPlane from user */;
		ASSETS: Fetcher;
	}
}
