/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 43a2dda5ce77aa5db02e9f2b70a3a7a5)
// Runtime types generated with workerd@1.20251105.0 2025-11-09 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UserControlPlane" | "UserDataPlane";
	}
	interface Env {
		USER_CONTROL_PLANE: DurableObjectNamespace<import("./src/index").UserControlPlane>;
		USER_DATA_PLANE: DurableObjectNamespace<import("./src/index").UserDataPlane>;
	}
}
